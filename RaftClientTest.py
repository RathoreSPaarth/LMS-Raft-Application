...
class LMSClient:
    ...
    def login(self, username, password):
        ...
        try:
            ...
            print(f"Failed to login via the leader node: {e}")
            return False
    ...
    def post(self, data_type, data):
        ...
        try:
            ...
            if response.success:
                ...
                print("YE EXCEPTION HAI MADhARCHOD")
                print(f"Post failed via {leader_address}. Message: {response.message}")
                return False

        except grpc.RpcError as e:
            print(f"Error posting data via leader node: {e}")
            return False
    ...
    def get(self, data_type):
        ...
        try:
            ...
            print(f"Error retrieving data via leader node: {e}")
            return False
    ...
    def logout(self):
        ...
        try:
            ...
            print(f"Failed to logout via leader node: {e}")
            return False
    ...
    def get_leader_port(self):
        ...
        for node, port in node_ports.items():
            try:
                ...
                print(f"Error connecting to node {node} at port {port}: {e}")
...
if __name__ == '__main__':
    ...
    # Login as student
    # if client.login("student", "student_pass"):
    #     # Post some data (this will go to the leader)
    #     client.post("assignment", "Assignment 2: CS Homework")
